...
const MontajAcoperisuriTargoviste: React.FC = () => {
  const services: Service[] = [
    {
      title: 'Montaj Acoperisuri',
      description: 'Instalare profesională de acoperișuri noi cu materiale premium în Târgoviște.',
      image: montajImage,
    },
    {
      title: 'Renovare',
      description: 'Renovăm și modernizăm acoperișuri existente în Târgoviște pentru o durată de viață extinsă.',
      image: renovareImage,
    },
    {
      title: 'Reparații',
      description: 'Servicii rapide și eficiente de reparații pentru orice tip de acoperiș în Târgoviște.',
  ...
  return (
    <div className="pt-16">
      <Helmet>
        <title>Montaj Acoperisuri în Târgoviște - Smart Roof Constantin</title>
        <meta
          name="description"
          content="Montaj profesional de acoperișuri în Târgoviște. Contactează Smart Roof Constantin pentru oferte personalizate."
        />
        <meta
          name="keywords"
          content="montaj acoperisuri Târgoviște, reparații acoperisuri Târgoviște, renovare acoperisuri Târgoviște"
        />
        <meta property="og:title" content="Montaj Acoperisuri în Târgoviște - Smart Roof Constantin" />
        <meta
      ...
      >
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          >
            Montaj Acoperișuri în Târgoviște
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Oferim servicii de montaj, renovare și reparații acoperișuri în Târgoviște, la cele mai înalte standarde.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
            Serviciile Noastre în Târgoviște
          </h2>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
            De ce să alegi Smart Roof Constantin în Târgoviște?
          </h2>
...
export default MontajAcoperisuriTargoviste;