...
const MontajAcoperisuriIlfov: React.FC = () => {
  ...
  return (
    <div className="pt-16">
      <Helmet>
        <title>Montaj Acoperisuri în Ilfov - Smart Roof Constantin</title>
        <meta
          name="description"
          content="Montaj profesional de acoperișuri în Ilfov. Contactează Smart Roof Constantin pentru oferte personalizate."
        />
        <meta
          name="keywords"
          content="montaj acoperisuri Ilfov, reparații acoperisuri Ilfov, renovare acoperisuri Ilfov"
        />
        <meta property="og:title" content="Montaj Acoperisuri în Ilfov - Smart Roof Constantin" />
        <meta
      ...
      >
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          >
            Oferim servicii de montaj, renovare și reparații acoperișuri în Ilfov, la cele mai înalte standarde.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
            De ce să alegi Smart Roof Constantin în Ilfov?
          </h2>
...
export default MontajAcoperisuriIlfov;
